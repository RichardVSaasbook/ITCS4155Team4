...
bridges.config(function($stateProvider, $urlRouterProvider) {
	...
	.state("profile", {
		url: "/profile",
		views: {
			"info": {templateUrl: "/angular_templates/users/profile/info.html", 		controller: 'UsersCtrl'},
			"form@profile": {templateUrl: "/angular_templates/users/profile/form.html", controller: 'UsersCtrl'}
		}
	})
